...
public class SignUpPage extends Page {
	...
	private final String createAccountName = "Create Account";
	@iOSFindBy(id=createAccountName) private IOSElement createAnAccount;
	...
	//@iOSFindBy(accessibility = "IHRAuthorizationView-LogInAuthButton-UIButton") private IOSElement create;
	@iOSFindBy(xpath="//UIAApplication[1]/UIAWindow[1]/UIAButton[4]") private IOSElement create;
